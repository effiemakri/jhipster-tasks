...
import eu.telint.tasks.TasksApp;
import eu.telint.tasks.domain.Authority;
import eu.telint.tasks.domain.User;
import eu.telint.tasks.repository.AuthorityRepository;
...
import eu.telint.tasks.web.rest.errors.ExceptionTranslator;
import eu.telint.tasks.web.rest.vm.KeyAndPasswordVM;
import eu.telint.tasks.web.rest.vm.ManagedUserVM;
